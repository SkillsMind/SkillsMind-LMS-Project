...
const LoginSignup = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // ⭐⭐⭐ DASHBOARD KE LIYE IMPORTANT - YEH 2 LINES ADD KI HAIN ⭐⭐⭐
        ...
        setTimeout(() => {
          if (data.user.role === 'admin') {
            ...
            if (data.user.profileId) navigate('/get-enrolment');
            else navigate('/student-profile-form');
          }
        }, 1000);
      } else { 
  ...
  // (Baqi saara Reset Password aur JSX code same rahay ga...)
