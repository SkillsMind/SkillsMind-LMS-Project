      ...
      <section className="service-hero-modern">
        <div className="container">
          <div className="hero-content">
            <h1 className="hero-title">Digital <span className="highlight">Marketing & Ads</span></h1>
            <p className="hero-desc">Grow your business with data-driven marketing strategies.</p>
